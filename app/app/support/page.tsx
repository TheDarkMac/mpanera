  ...
  return (
    <div className="h-full overflow-y-auto">
      <PageIntro
        ...
        actions={
          <ActionLink href="/app/parametres">Manage preferences</ActionLink>
        }
      />
        ...
        <div className="grid gap-4 lg:grid-cols-3">
          <Surface className="space-y-3">
            ...
            <p className="text-sm leading-6 text-muted-foreground">
              Direct access to common blockers: no reply to a request, missing
              messages, or confusion about a step.
            </p>
          </Surface>
          <Surface className="space-y-3">
            ...
            <p className="text-sm leading-6 text-muted-foreground">
              Planned area for reporting disputes, abuse, fraud, or problematic
              profiles.
            </p>
          </Surface>
          <Surface className="space-y-3">
            ...
            <p className="text-sm leading-6 text-muted-foreground">
              Ticket history, priority, and current handling status once support
              has been contacted.
            </p>
          </Surface>
        </div>
        ...
        <div className="grid gap-4 xl:grid-cols-[1.1fr_0.9fr]">
          ...
          <Surface className="space-y-4">
            ...
            <div className="flex items-start gap-3 rounded-lg border border-border/70 px-4 py-4 text-sm text-muted-foreground">
              ...
              The form should later provide a simple status flow: received, in
              progress, resolved.
            </div>
          </Surface>
        </div>
